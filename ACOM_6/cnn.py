...
#         arch_num += 1
#         #полносвязная модель
#         models = Sequential(architecture)
...
#         models.fit(train_images, train_labels, epochs=params['epochs'], batch_size=params['batch_size'], validation_split=0.2)
#         end_time = time.time()
...
#
#         # Сохранение модели
#         models.save(f'models/cnn_model{arch_num}{params["code"]}.keras')
#
