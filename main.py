...
def main(path, standard_deviation, kernel_size, lower_bound, upper_bound, operator):
    ...
    print(matr_gradient)
    cv2.imshow('matr_grad', matr_gradient)
    print('Матрица значений углов градиента:')
    print(img_angles)
    cv2.imshow('angle_matrix', img_angles)
    ...
    cv2.imwrite('images/border.jpg', img_border)
...
main('images/image.jpg', 6, 5, 0.2, 0.4, 'sobel')
#main('images/image.jpg', 100, 11, 0.15, 0.85, 'sobel')
#main('images/image.jpg', 10, 3, 0.2, 0.4, 'previtta')
cv2.waitKey(0)
